...
public struct TimedLock : IDisposable
{
    ...
    public static TimedLock Lock(object o, TimeSpan timeout)
    {
        ...
        var timedLock = new TimedLock(o);
            //LockTimeoutException.ReportStackTraceIfError(o);
            //LockTimeoutException timeException = new LockTimeoutException(o);
    ...
    public class LockTimeoutException : Exception
    {
            ...
            : base("Timeout waiting for lock")
        {
            ...
            //Console.WriteLine("Setting target:" + Thread.CurrentThread.Name);
        ...
        public StackTrace GetBlockingStackTrace(int timeout)
        {
            ...
            if (lockTarget == null)
            {
                Console.WriteLine("GetBlockingStack trace Null target?!?!");
            }
